...
scen <- read.csv('Data/Model params_0707_test.csv')
...
seir1 <- function(t, x, parms) {
  ...
  with(as.list(c(parms, x)), {
    ...
    ef1 <- ifelse(t<t2, 0, ifelse(t<t3, mag1, ifelse(t<t4, mag2, ifelse(t<t4a, mag3, ifelse(t<t5, mag3a, ifelse(t<t5a, mag4, ifelse(t<t5b, mag4a, ifelse(t<t6,  mag4b, ifelse( t< t6a, ef1_1, ifelse(t<t7,  mag5, ifelse(t<t8, ef1_2, ef1_3)))))))))))
...
write.csv(all.scen, './allscenarios_0707_test.csv', row.names = F)
