                                          ...
                                          tags$ul(
                                            ...
                                            tags$li(HTML(paste0("Model fit and parameter estimates September 07, 2020 (", 
                                                                a(href = "ParameterEstimatesAndModelFit_20200907.pdf", 
                                                                  "LINK", target = "_blank"),
                                                                ")"))),
                                            tags$li(HTML(paste0("Model fit and parameter estimates September 14, 2020 (", 
                                                                a(href = "ParameterEstimatesAndModelFit_20200914.pdf", 
                                                                  "LINK", target = "_blank"),
                                                                ")"))),
                                            tags$li(HTML(paste0("Model fit and parameter estimates September 21, 2020 (", 
                                                                a(href = "ParameterEstimatesAndModelFit_20200921.pdf", 
                                                                  "LINK", target = "_blank"),
                                                                ")"))),
                                            tags$li(HTML(paste0("Model fit and parameter estimates September 28, 2020 (", 
                                                                a(href = "ParameterEstimatesAndModelFit_20200928.pdf", 
                                                                  "LINK", target = "_blank"),
                                                                ")"))),
                                            tags$li(HTML(paste0("Model fit and parameter estimates October 05, 2020 (", 
                                                                a(href = "ParameterEstimatesAndModelFit_20201005.pdf", 
                                                                  "LINK", target = "_blank"),
                                                                ")"))),
                                            tags$li(HTML(paste0("Model fit and parameter estimates October 12, 2020 (", 
                                                                a(href = "ParameterEstimatesAndModelFit_20201012.pdf", 
                                                                  "LINK", target = "_blank"),
                                                                ")")))
                                          ),
