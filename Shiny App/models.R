...
seir1 <- function(t, x, parms) {
  ...
  with(as.list(c(parms, x)), {
    ...
    ef1 <- ifelse(t<t2, 0, ifelse(t<t3, mag1, ifelse(t<t4, mag2, ifelse(t<t4a, mag3, ifelse(t<t5, mag3a, ifelse(t<t5a, mag4, ifelse(t<t5b, mag4a, ifelse(t<t6,  mag4b, ifelse( t< t6a, ef1_1, ifelse(t<t6b,  mag5, ifelse (t<t6c, mag5a, ifelse (t<t6d, mag5b, ifelse( t< t7, mag5c,ifelse(t<t8,  ef1_2, ef1_3))))))))))))))
...
#     
#     # change over time in efficacy of % mag SD among specific age groups
#     ef1 <- ifelse(t<t2, 0, ifelse(t<t3, mag1, ifelse(t<t4, mag2, ifelse(t<t4a, mag3, ifelse(t<t5, mag3a, ifelse(t<t5a, mag4, ifelse(t<t5b, mag4a, ifelse(t<t6,  mag4b, ifelse( t< t6a, ef1_1, ifelse(t<t6b,  mag5, ifelse (t<t6c, mag5a, ifelse(t<t7, mag5b, ifelse(t<t7b, ef1_2, ifelse(t<t8, ef1_3, ef1_4))))))))))))))
#     #ef2 <- ifelse(t<t7, ef1, ifelse(t<t7b, ef2_2, ifelse(t<t8, ef2_3, ef2_4)))
#     #ef3 <- ifelse(t<t7, ef1, ifelse(t<t7b, ef3_2, ifelse(t<t8, ef3_3, ef3_4)))
#     #ef4 <- ifelse(t<t7, ef1, ifelse(t<t7b, ef4_2, ifelse(t<t8, ef4_3, ef4_4)))
#     ef4 <- ifelse(t<t7, ef1, (ef1*(1-ef4p)) + (ef4p*0.8)) #ef4p is the proportion of adults over 65 practicing high (80%) social distancing
#     
#     siI <- ifelse (t < t1, 0, siI) ##Turn on symptomatics that self-isolate after 03/05
#     ramp <-ifelse(t < 129, 0, ifelse(t<134,(t-129)*ramp, 4.4*ramp)) #For ramp up in case isolation : increases proportion of symptomatic case isoaltion over time
#     maska <- ifelse(t< 73, 0, ifelse(t< t4,maska, ifelse (t<t7, maskb, ifelse(t<t7b, maskc, maskc))))
#     CT  <- ifelse(t < t7, 0, pCT)
#     #temp <- ifelse (t > 1, ifelse(temp_on == 1, temptheory$temp.param[[t]],1), 1)
#     temp <-ifelse(temp_on == 1, 0.5*cos((t+45)*0.017)+1.5, 1)
#     
